...
<body class="m-0 p-0">
        ...
        <div>
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container-fluid">
                    <a class="navbar-brand text-warning" href="#">DailyBits</a>
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <li><li class="nav-item">Signed in as <?php echo $_SESSION['usr_name']; ?></p></li>
  ...
  <form action="" class="language-picker__form">
    ...
    <select name="language-picker-select" id="langBtn">
            ...
            <div>
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark mt-4">
                  <div class="container-fluid m-0 p-0">
                    ...
                    <h5 class="text-white me-auto ms-auto">Daily<span class="text-warning">Bits</span></h5>
                  </div>
                </nav>
              </div>
        </div>
 ...
 */
$('.btan-counter').on('click', function(event, count) {
  event.preventDefault();
  
  var $this = $(this),
      count = $this.attr('datacount'),
  ...
  $.fn.noop = $.noop;
  $this.attr('datacount', ! active || multiple ? ++count : --count  )[multiple ? 'noop' : 'toggleClass']('active');
